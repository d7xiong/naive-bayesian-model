...
public class CountStatisticsTestWithDirFile {
	...
	public static void main(String[] args) throws IOException {
		...
		for (String testContent : testContentList) {
			...
			System.out.println("类型：" + categoryName + "\t" + bigDecimal.toEngineeringString());
		}

		System.out.println(" done ...");
	}

	public static List<String> buildContents(String dirFilePath) throws IOException {
		List<String> contentList = new ArrayList<String>();
		File dirFile = new File(dirFilePath);
		for (File file : dirFile.listFiles()) {
			contentList.add(TextUtil.loadFile(file, "gb2312"));
		}
		return contentList;
	}
}
